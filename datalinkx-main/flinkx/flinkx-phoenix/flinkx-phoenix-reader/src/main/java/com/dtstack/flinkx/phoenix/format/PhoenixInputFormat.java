...
public class PhoenixInputFormat extends JdbcInputFormat {
    ...
    public void openInternal(InputSplit inputSplit) throws IOException {
        try {
            ...
            URLClassLoader childFirstClassLoader = FlinkUserCodeClassLoaders.childFirst(needJar.toArray(new URL[0]), parentClassLoader, alwaysParentFirstPatterns, new Consumer<Throwable>() {
                @Override
